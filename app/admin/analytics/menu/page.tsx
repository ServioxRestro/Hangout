...
export default function MenuAnalyticsPage() {
  ...
  const categoryData = Object.entries(menu.byCategory || {}).map(([category, data]: [string, any]) => ({
    category,
  ...
  const vegNonVegData = [
    { name: "Veg", value: menu.vegNonVeg.veg.quantity, revenue: menu.vegNonVeg.veg.revenue },
    { name: "Non-Veg", value: menu.vegNonVeg.nonVeg.quantity, revenue: menu.vegNonVeg.nonVeg.revenue },
  ];
    ...
    <div className="p-6 max-w-[1600px] mx-auto">
      ...
      <div className="flex items-center justify-between mb-8">
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <p className="text-gray-600 mt-1">Analyze top selling items, category trends, and menu optimization</p>
          </div>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
        <Card className="p-6">
          <div className="flex items-start justify-between">
            <div>
              <p className="text-sm text-gray-600 font-medium">Total Items Sold</p>
        ...
        <Card className="p-6">
          <div className="flex items-start justify-between">
            <div>
              <p className="text-sm text-gray-600 font-medium">Veg Items Sold</p>
              <p className="text-3xl font-bold text-gray-900 mt-2">
        ...
        <Card className="p-6">
          <div className="flex items-start justify-between">
            <div>
              <p className="text-sm text-gray-600 font-medium">Non-Veg Items Sold</p>
              <p className="text-3xl font-bold text-gray-900 mt-2">
      ...
      <Card className="p-6 mb-8">
        <div className="flex items-center justify-between mb-6">
          <div>
            ...
            <p className="text-sm text-gray-600">Best performing menu items by quantity sold</p>
          </div>
        ...
        {menu.topItems.length > 0 ? (
            ...
            {menu.topItems.map((item: any, index: number) => (
              ...
              >
                ...
                <div className="text-right">
                  <p className="text-lg font-bold text-gray-900">{item.quantity} sold</p>
          ...
          <div className="flex flex-col items-center justify-center h-40 text-gray-400">
            ...
            <p className="text-sm">No item sales data available for this period</p>
          </div>
        )}
      </Card>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        ...
        <Card className="p-6">
          <div className="flex items-center justify-between mb-6">
            <div>
              ...
              <p className="text-sm text-gray-600">Quantity sold per category</p>
            </div>
        ...
        <Card className="p-6">
          <div className="flex items-center justify-between mb-6">
            <div>
              <h3 className="text-lg font-bold text-gray-900">Veg vs Non-Veg</h3>
          ...
          {menu.totalItemsSold > 0 ? (
            <>
              ...
              <div className="mt-6 grid grid-cols-2 gap-4">
                <div className="bg-green-50 rounded-lg p-4 border border-green-200">
                  ...
                  <p className="text-2xl font-bold text-gray-900">{menu.vegNonVeg.veg.quantity}</p>
                  <p className="text-sm text-gray-600 mt-1">{formatCurrency(menu.vegNonVeg.veg.revenue)}</p>
                </div>
                ...
                <div className="bg-red-50 rounded-lg p-4 border border-red-200">
                  ...
                  <p className="text-2xl font-bold text-gray-900">{menu.vegNonVeg.nonVeg.quantity}</p>
                  <p className="text-sm text-gray-600 mt-1">{formatCurrency(menu.vegNonVeg.nonVeg.revenue)}</p>
                </div>
              </div>
            </>
          ) : (
            <div className="flex flex-col items-center justify-center h-64 text-gray-400">
              ...
              <p className="text-sm">No food type data available for this period</p>
            </div>
          )}
        </Card>
      </div>
