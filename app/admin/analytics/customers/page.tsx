    ...
    <div className="p-6 max-w-[1600px] mx-auto">
      ...
      <div className="flex items-center justify-between mb-8">
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <p className="text-gray-600 mt-1">Understand customer behavior, retention, and top spenders</p>
          </div>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
        ...
        <Card className="p-6">
          <div className="flex items-start justify-between">
            <div>
              <p className="text-sm text-gray-600 font-medium">Returning Customers</p>
              <p className="text-3xl font-bold text-gray-900 mt-2">
      ...
      <Card className="p-6 mb-8">
        ...
        {customers.trend && customers.trend.length > 0 ? (
          ...
          <div className="flex flex-col items-center justify-center h-64 text-gray-400">
            ...
            <p className="text-sm">No customer acquisition data available for this period</p>
          </div>
        )}
      </Card>
      ...
      <Card className="p-6">
        ...
        {customers.topCustomers && customers.topCustomers.length > 0 ? (
          ...
          <div className="flex flex-col items-center justify-center h-40 text-gray-400">
            ...
            <p className="text-sm">No customer data available for this period</p>
          </div>
        )}
      </Card>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-8">
        <Card className="p-6">
          <h3 className="text-lg font-bold text-gray-900 mb-4">Customer Breakdown</h3>
            ...
            <div className="flex items-center justify-between p-4 bg-green-50 rounded-lg border border-green-200">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-2xl font-bold text-gray-900">{customers.new}</p>
                </div>
              </div>
              <div className="text-right">
                <p className="text-sm text-gray-600">Percentage</p>
                <p className="text-lg font-bold text-green-600">
                  {customers.total > 0 ? ((customers.new / customers.total) * 100).toFixed(1) : 0}%
                </p>
              </div>
            </div>
            ...
            <div className="flex items-center justify-between p-4 bg-blue-50 rounded-lg border border-blue-200">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-2xl font-bold text-gray-900">{customers.returning}</p>
                </div>
              </div>
              <div className="text-right">
                <p className="text-sm text-gray-600">Percentage</p>
                <p className="text-lg font-bold text-blue-600">
                  {customers.total > 0 ? ((customers.returning / customers.total) * 100).toFixed(1) : 0}%
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="space-y-4">
            <div className="p-4 bg-purple-50 rounded-lg border border-purple-200">
              <div className="flex items-center justify-between mb-2">
                <span className="text-sm text-gray-600">Average Spend Per Customer</span>
                <DollarSign className="w-5 h-5 text-purple-600" />
              </div>
              <p className="text-2xl font-bold text-gray-900">{formatCurrency(customers.averageSpend)}</p>
            </div>
            ...
            <div className="p-4 bg-amber-50 rounded-lg border border-amber-200">
              ...
              <p className="text-xs text-gray-500 mt-1">Customers with 2+ visits</p>
            </div>
          </div>
        </Card>
      </div>
