...
import { useOffersAnalytics, type Period } from "@/hooks/useAnalytics";
...
export default function OffersAnalyticsPage() {
  ...
  const { data: analytics, isLoading, error } = useOffersAnalytics({ period });
      ...
      <Card className="p-6 mb-8">
        ...
        {offers.topOffers && offers.topOffers.length > 0 ? (
                ...
                >
                  ...
                  <div className="text-right">
                    ...
                    <p className="text-sm text-red-600 font-medium">
                      -{formatCurrency(offer.totalDiscount)}
                    </p>
                  </div>
                </div>
              ))}
                      ...
                      return (
                        <div className="bg-white p-3 border border-gray-200 rounded-lg shadow-lg">
                          ...
                          <p className="text-xs text-red-600">
                            Discount:{" "}
                            {formatCurrency(payload[0].payload.totalDiscount)}
                          </p>
                        </div>
                      );
                    }
          ...
          <div className="flex flex-col items-center justify-center h-64 text-gray-400">
            ...
            <p className="text-sm">
              No offer usage data available for this period
            </p>
          </div>
        )}
      </Card>
            ...
            <>
                ...
                <PieChart>
                  <Pie
                    data={[
                      ...
                      {
                        name: "Inactive",
                        value: offers.totalOffers - offers.activeOffers,
                      },
                    ]}
                    cx="50%"
                    cy="50%"
              ...
              <div className="grid grid-cols-2 gap-4 mt-4">
                ...
                <div className="bg-gray-50 rounded-lg p-4 border border-gray-200">
                  ...
                  <p className="text-2xl font-bold text-gray-900">
                    {offers.totalOffers - offers.activeOffers}
                  </p>
                </div>
              </div>
            </>
          ...
          <div className="space-y-4">
            <div className="p-4 bg-blue-50 rounded-lg border border-blue-200">
              <div className="flex items-center justify-between mb-2">
                <span className="text-sm text-gray-600">
                  Average Usage Per Offer
                </span>
                <Award className="w-5 h-5 text-blue-600" />
              </div>
              <p className="text-2xl font-bold text-gray-900">
                {offers.totalOffers > 0
                  ? (offers.totalUsage / offers.totalOffers).toFixed(1)
                  : 0}
              </p>
            ...
            <div className="p-4 bg-red-50 rounded-lg border border-red-200">
              ...
              <p className="text-2xl font-bold text-gray-900">
                {formatCurrency(
                  offers.totalUsage > 0
                    ? offers.totalDiscount / offers.totalUsage
                    : 0
                )}
              </p>
            ...
            <div className="p-4 bg-pink-50 rounded-lg border border-pink-200">
              ...
              <p className="text-2xl font-bold text-gray-900">
                {offers.totalOffers > 0
                  ? ((offers.activeOffers / offers.totalOffers) * 100).toFixed(
                      1
                    )
                  : 0}
                %
